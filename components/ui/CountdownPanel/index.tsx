      ...
      <div className="px-2 flex flex-col items-center text-center gap-3">
        ...
        <div className="max-w-lg mt-2 text-slate-400">
          ...
          <div className="mt-3 sm:block border border-orange-500 bg-slate-900 rounded-md p-3 pt-2 border-dasheds">
            ...
            <a target="_blank" className=" text-slate-300 transition-opacity hover:text-scale-1200" href="https://dub.sh/countvisits">
            <span className='text-lg text-white font-bold'>CountVisits.com</span> <br/> 
            Web Analytics tool you pay once and use for life.


           <span className='mt-4 mb-3 block w-52 mx-auto bg-orange-500 text-white p-1 text-sm rounded'>Start A Free Trial</span>
            </a>
