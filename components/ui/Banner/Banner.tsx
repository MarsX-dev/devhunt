    ...
    <div className="bg-orange-600">
      <div className="custom-screen py-3 items-center gap-x-4 justify-between text-white font-medium sm:flex md:px-8">
        <div className="flex items-center">
          <img src="https://user-uploads-unicorn.s3.amazonaws.com/product_hunt_kitty.png" loading="lazy" alt="PH kitty" className="w-24" />
          <p>Support us: DevHunt is on Product Hunt now</p>
        </div>
        <LinkItem
          href="https://www.producthunt.com/products/devhunt-2"
          target="_blank"
