...
export default () => {
  ...
  return (
    <footer className="text-slate-500 bg-slate-900 px-4 py-5 max-w-screen-xl mx-auto md:px-8">
      <div className="max-w-lg sm:mx-auto sm:text-center">
        <Brand className={'m-auto'} />
        <p className="leading-relaxed mt-3 text-[15px]">
      ...
      <div className="mt-8 items-center justify-between sm:flex">
        ...
        <div className="mt-6 sm:mt-0">
          <ul className="flex items-center space-x-4">
            <li className="w-10 h-10 border border-slate-800 rounded-full flex items-center justify-center">
