...
async function getPosts(slug: string) {
  ...
  try {
    const res = await fetch(`https://app.seobotai.com/api/articles?key=${key}&host=${host}&page=0&limit=100&categorySlug=${slug}`);
...
export default async function Tag({ params: { slug } }: { params: { slug: string } }) {
